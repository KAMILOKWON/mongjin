...
const translations: Record<Locale, TranslationTable> = {
  ...
  en: {
    ...
    'meta.description': 'A two-player abstract strategy game where you escort your king to the opponent\'s goal',
    'brand.title': 'Mongjin',
    ...
    'menu.random.title': 'Random Match',
    ...
    'menu.friend.description': 'Use room code to play with friends',
    'menu.tutorial.title': 'Tutorial',
    'menu.tutorial.description': 'Learn rules in 4 steps',
    'preview.aria': 'Mongjin initial setup preview',
    'preview.caption': 'Escort your king to the goal in the opponent\'s territory.',
    ...
    'color.random': 'Random',
    'friend.or': 'or',
    'friend.shareHint': 'Share room code with your friend',
    ...
    'setup.easy.option': 'Easy · Learn basic moves and tactics',
    'setup.normal.option': 'Normal · Read beginner tactics and defense',
    'setup.hard.option': 'Hard · Deep search up to 4.3s for best move',
    'setup.side': 'My Side',
    'setup.start': 'Start Game',
    'setup.local': 'Local 2-player on one device',
    'profile.eyebrow': 'PLAYER PROFILE',
    'profile.title': 'My Profile',
    'profile.nickname': 'Nickname',
    'profile.placeholder': '2-12 characters',
    'profile.save': 'Save',
    'profile.stats': 'Random match stats',
    'profile.rank': 'Global rank',
    'profile.rankPlaceholder': 'Rank -',
    'profile.ratingPlaceholder': 'Rating -',
    'profile.rating': 'Rating {rating} · {total} players',
    'profile.wins': 'Wins',
    'profile.losses': 'Losses',
    'profile.winRate': 'Win rate',
    'profile.note': 'Only random match results count toward official stats.',
    'profile.loadingRecord': 'Loading stats',
    'tutorial.eyebrow': 'HOW TO PLAY',
    'tutorial.title': 'Escort your king',
    'tutorial.progress': 'Tutorial progress',
    'tutorial.previous': 'Previous',
    'tutorial.next': 'Next',
    'tutorial.startPractice': 'Start practice game',
    'tutorial.step1.title': 'Escort your king',
    'tutorial.step1.copy': 'Move your king to one of the three center squares of the opponent\'s back row to win.',
    'tutorial.step1.alt': 'Black king moving toward the center goal squares on the opponent\'s back row',
    'tutorial.step2.title': 'Place guards',
    'tutorial.step2.copy': 'Each turn you may place one guard on an empty square adjacent to your pieces. Each side has 8 guards.',
    'tutorial.step2.alt': 'Placing a new guard adjacent to the king and guards',
    'tutorial.step3.title': 'Place or move',
    'tutorial.step3.copy': 'Each turn, place a guard or move one piece. Kings move 8 directions, guards move orthogonally one square.',
    'tutorial.step3.alt': 'King moves 8 directions, guards move 4 orthogonal directions',
    'tutorial.step4.title': 'Protect your king',
    'tutorial.step4.copy': 'Guards can capture opponent guards and kings. If your king is captured, you lose immediately. Don\'t rush alone.',
    'tutorial.step4.alt': 'Three guards surrounding the king and blocking opponent guards',
    'status.turn': '{player}\'s turn',
    ...
    'reason.goal': 'King reached goal',
    'reason.capture': 'Captured opponent king',
    'reason.surround': 'Surrounded opponent king',
    'reason.no-moves': 'Opponent has no moves',
    'reason.forfeit': 'Opponent left the game',
    'status.code': 'Room code {code} — {side}',
    'status.code.waiting': 'Room code {code} — {side} (waiting for opponent)',
    'status.matched': 'Matched with {name} — {side}',
    'profile.saved': 'Saved',
    'profile.saving': 'Saving…',
    'profile.invalid': 'Nickname must be 2-12 characters',
    'clipboard.copied': 'Room code {code} copied — Share with your friend',
    'clipboard.manual': 'Please select and copy the code manually',
    'online.setupHint': 'Create a room code or enter a code to join',
    'online.noCode': 'Please enter room code',
    'online.opponentSearching': 'Looking for opponent',
    'online.matchCanceled': 'Matchmaking canceled',
    'online.ended': 'Match ended',
    ...
    'server.badResponse': 'Cannot read server response',
    ...
    'server.joinBeforeMove': 'Join room before making a move',
    'server.roomMissing': 'Room does not exist',
    'server.notRoomPlayer': 'Not a player in this room',
    'server.notYourTurn': 'Not your turn',
    'server.gameOver': 'Game already over',
